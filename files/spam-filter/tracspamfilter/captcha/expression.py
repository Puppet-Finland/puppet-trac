...
from tracspamfilter.api import N_, _, gettext
...
class ExpressionCaptcha(Component):
    ...
    numerals = (N_("zero"), N_("one"), N_("two"), N_("three"),
                N_("four"), N_("five"), N_("six"), N_("seven"),
                N_("eight"), N_("nine"), N_("ten"), N_("eleven"),
                N_("twelve"), N_("thirteen"), N_("fourteen"),
                N_("fifteen"), N_("sixteen"), N_("seventeen"),
                N_("eighteen"), N_("nineteen"))
